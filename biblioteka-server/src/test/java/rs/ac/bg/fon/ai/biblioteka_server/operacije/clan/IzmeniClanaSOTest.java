...
class IzmeniClanaSOTest {
	...
	@Test
	void testIzmeniClanaSO() {
		IzmeniClanaSO operacija = new IzmeniClanaSO();
		assertNotNull(operacija);
	}

	@Test
	void testIzmeniClanaSORepository() {
		IzmeniClanaSO operacija = new IzmeniClanaSO(brokerMock);
		assertNotNull(operacija);
	}

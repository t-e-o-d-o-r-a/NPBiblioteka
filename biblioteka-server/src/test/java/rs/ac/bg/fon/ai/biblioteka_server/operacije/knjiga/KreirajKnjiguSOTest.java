...
class KreirajKnjiguSOTest {
    ...
    KreirajKnjiguSO operacija;

	@BeforeEach
	void setUp() throws Exception {
		brokerMock = EasyMock.createMock(DBRepositoryGeneric.class);
        operacija = new KreirajKnjiguSO(brokerMock);
	}
	...
	@Test
	void testKreirajKnjiguSO() {
		KreirajKnjiguSO operacija = new KreirajKnjiguSO();
        assertNotNull(operacija);
	}

	@Test
	void testKreirajKnjiguSORepository() {
		KreirajKnjiguSO operacija = new KreirajKnjiguSO(brokerMock);
        assertNotNull(operacija);
	}

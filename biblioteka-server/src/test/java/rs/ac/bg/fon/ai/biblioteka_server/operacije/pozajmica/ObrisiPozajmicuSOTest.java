...
class ObrisiPozajmicuSOTest {
	
	DBRepositoryGeneric brokerMock;
    ObrisiPozajmicuSO operacija;

	@BeforeEach
	void setUp() throws Exception {
		brokerMock = EasyMock.createMock(DBRepositoryGeneric.class);
        operacija = new ObrisiPozajmicuSO(brokerMock);
	}
	...
	@Test
	void testObrisiPozajmicuSO() {
		ObrisiPozajmicuSO operacija = new ObrisiPozajmicuSO();
        assertNotNull(operacija);
	}

	@Test
	void testObrisiPozajmicuSORepository() {
		ObrisiPozajmicuSO operacija = new ObrisiPozajmicuSO(brokerMock);
        assertNotNull(operacija);
	}
